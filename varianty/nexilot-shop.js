...
function changeVariant(variant) {
    ...
    const variants = {
        mini: {
            title: "Nexilot Shop Mini",
            price: "19 970 €",
            description: `<h2>Popis</h2><p><strong>Nexilot Shop Mini:</strong> Ponúka útulný a moderný obchodný priestor.
            <span id="moreText" class="more-text"> Okrem moderného dizajnu a kvalitných materiálov ponúka aj energetickú úspornosť a udržateľnosť. Ideálny pre malé podniky alebo pop-up obchody. S veľkými oknami a otvoreným priestorom prináša množstvo prirodzeného svetla a spojenie s prírodou. Montáž je rýchla a jednoduchá, a priestor je možné prispôsobiť individuálnym požiadavkám klienta.</span></p>
            <h3>Dizajn a Exteriér:</h3>
            <p>Obchodný priestor má moderný a minimalistický dizajn s čistými líniami a elegantným vzhľadom. Exteriér je vyrobený z odolných materiálov, ktoré zabezpečujú dlhú životnosť a minimálnu údržbu.</p>`
        },
        standard: {
            title: "Nexilot Shop Standard",
            price: "29 970 €",
            description: `<h2>Popis</h2><p><strong>Nexilot Shop Standard:</strong> Ideálny pre stredne veľké podniky, ponúka priestrannejší obchodný priestor.
        ...
        premium: {
            title: "Nexilot Shop Premium",
            price: "39 970 €",
            description: `<h2>Popis</h2><p><strong>Nexilot Shop Premium:</strong> Luxusný a priestranný obchodný priestor pre náročných klientov.
        ...
        custom: {
            title: "Nexilot Shop Custom",
            price: "49 970 €",
            description: `<h2>Popis</h2><p><strong>Nexilot Shop Custom:</strong> Plne prispôsobiteľný obchodný priestor podľa vašich predstáv.
            <span id="moreText" class="more-text"> Ponúka moderný dizajn a kvalitné materiály, energetickú úspornosť a udržateľnosť. S veľkými oknami a otvoreným priestorom prináša množstvo prirodzeného svetla a spojenie s prírodou. Montáž je rýchla a jednoduchá, a priestor je možné prispôsobiť individuálnym požiadavkám klienta.</span></p>
            <h3>Dizajn a Exteriér:</h3>
